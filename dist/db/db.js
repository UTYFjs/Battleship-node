...
export const addUsersToRoom = (indexRoom, userId, name) => {
...
export const createGame = (currentRoom) => {
...
const getCoordinatesAroundShip = (shipCoordinates) => {
    ...
    const coordinatesAroundShip = Array.from(coordinatesSet);
    const result = [];
    coordinatesAroundShip.forEach((coord) => {
